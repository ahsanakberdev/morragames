...
// import Pyramid from '../assets/img/Pyramid.mp4'
import karnakimagebg from '../assets/img/karnak-gig-imagebg.webp'
                    ...
                    <div class="section">
                        <div class="container pad_8">
                            ...
                            <div className='featured_grid'>
                                ...
                                <div>
                                    <p className="extra-bold-p">Objectives</p>
                            ...
                            <div className='spacer-4'></div>
                            <div className='featured_grid featured_gridvid'>
                                {/* <div><img src={GameSection1Img1} alt="" /></div>
                                <div><img src={GameSection1Img2} alt="" /></div> */}
                                 <img src={karnakimagebg} alt='img'/>
                            </div>
                            <div className='spacer-4'></div>
                            <div className='featured_grid' style={{alignItems:'flex-end'}}>
                                <div>
                                    <div className="text_maxch-85">
                                        <div className="tag_wrapper">
